defmodule Tugas.Obligations.TypeTest do
  ...
  describe "create_type/2 and update_type/3" do
    ...
    test "updating complete_documents propagates to all live obligations of the type" do
      ...
      assert Tugas.Repo.get!(Tugas.Obligations.Obligation, live_two.id).complete_documents ==
               "payment_receipt"

      assert Tugas.Repo.get!(Tugas.Obligations.Obligation, done.id).complete_documents == ""
    end
  end
