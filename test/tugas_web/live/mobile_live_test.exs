defmodule TugasWeb.MobileLiveTest do
  ...
  test "mobile admin disables a member through the confirm modal", %{conn: conn} do
    ...
    membership = Tugas.Entities.get_membership!(member, admin.entity)
    ...
    assert Tugas.Entities.get_membership!(member, admin.entity).disabled_at
