defmodule ArgusWeb.UserAuth do
  ...
  the `current_scope`:
      ...
      defmodule ArgusWeb.PageLive do
        use ArgusWeb, :live_view

        on_mount {ArgusWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ArgusWeb.UserAuth, :require_authenticated}] do
