defmodule ArgusWeb.MobileLive.Login do
  ...
  defp local_mail_adapter? do
    Application.get_env(:argus, Argus.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
