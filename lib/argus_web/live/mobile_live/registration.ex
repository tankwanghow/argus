defmodule ArgusWeb.MobileLive.Registration do
        ...
        <div class="card-body gap-4">
          <div class="text-center">
            ...
            <p class="text-sm text-base-content/60 mt-1">
              Already registered?
              <.link navigate={~p"/m/users/log-in"} class="font-semibold text-primary hover:underline">
                Log in
              </.link>
            </p>
          </div>

          <.form for={@form} id="m-registration-form" phx-submit="save" phx-change="validate">
            <.input
              field={@form[:email]}
              type="email"
              label="Email"
    ...
    case Accounts.register_user(user_params) do
      {:ok, user} ->
        ...
        {:noreply,
         ...
         |> push_navigate(to: ~p"/m/users/log-in")}
