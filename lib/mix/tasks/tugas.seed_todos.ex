defmodule Mix.Tasks.Tugas.SeedTodos do
  ...
  Bulk-inserts open and completed todos for exercising the todos UI.
      ...
      mix tugas.seed_todos
      mix tugas.seed_todos --entity my-entity-slug
      mix tugas.seed_todos --count 500 --entity my-entity-slug
  ...
  alias Tugas.Repo
  alias Tugas.Todos.{AuditLog, Todo}
