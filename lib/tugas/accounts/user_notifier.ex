defmodule Tugas.Accounts.UserNotifier do
  import Swoosh.Email
  ...
  defp deliver(recipient, subject, body) do
    from_addr = Application.get_env(:tugas, :mail_from, {"Tugas", "noreply@tugas.asia"})
  ...
  def deliver_entity_invitation(email, entity_name, role, url) do
    deliver(email, "You're invited to #{entity_name} on Tugas", """

    ==============================

    Hi,

    You've been invited to join "#{entity_name}" on Tugas as #{role}.
