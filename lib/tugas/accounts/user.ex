defmodule Tugas.Accounts.User do
  use Tugas.Schema
  ...
  (via `TugasWeb.CoreComponents.user_label/1`).
  """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Tugas.Repo)
  ...
  """
  def valid_password?(%Tugas.Accounts.User{hashed_password: hashed_password}, password)
