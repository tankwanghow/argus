defmodule TugasWeb.UserAuth do
  ...
  @remember_me_cookie "_tugas_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_in_user(conn, user, params \\ %{}) do
    ...
    mobile? = TugasWeb.Device.mobile?(conn)
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      TugasWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule TugasWeb.PageLive do
        use TugasWeb, :live_view

        on_mount {TugasWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TugasWeb.UserAuth, :require_authenticated}] do
  ...
  def signed_in_path(
    ...
    default_entity_path(user, mobile: TugasWeb.Device.mobile?(conn))
  end
  ...
  defp mobile_from_socket?(socket), do: TugasWeb.Device.mobile_from_socket?(socket)
