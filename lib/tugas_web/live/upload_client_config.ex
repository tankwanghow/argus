defmodule TugasWeb.UploadClientConfig do
  @moduledoc """
  Client-side upload configuration for the `UploadDirect` hook. Documents are
  uploaded over a plain HTTP request (see `TugasWeb.DocumentController.create/2`),
  ...
  defp client_resize_config do
    case Application.get_env(:tugas, :upload_client_image_resize, %{}) do
