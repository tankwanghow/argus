defmodule TugasWeb.TodoLive.TeamLogHelpers do
  @moduledoc """
  ...
  `Tugas.Todos.list_entity_audit_logs_page/2`, rendered as a LiveView stream.
  """
  import Phoenix.Component, only: [assign: 3]
  import Phoenix.LiveView, only: [stream: 4]

  alias Tugas.Todos
  alias TugasWeb.TodoLive.ActivityFormat
