defmodule TugasWeb.ObligationLive.Show do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      ...
      >
        <section
          ...
          class="tugas-workbench w-[100%] mx-auto tugas-obligation-summary"
        >
          <div
            id="obligation-meta"
          ...
          <div
            ...
            class={TugasWeb.ObligationDocumentThumb.thumb_grid_classes(:desktop)}
          >
          ...
          >
            <div id="obligation-progress-actions" class="tugas-inline-actions">
              <button
            ...
            <div id="obligation-series-actions" class="tugas-inline-actions ml-auto">
              <button
