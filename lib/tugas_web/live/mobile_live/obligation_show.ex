defmodule TugasWeb.MobileLive.ObligationShow do
  use TugasWeb, :live_view
  use TugasWeb.ObligationLive.DocumentEvents

  import TugasWeb.ObligationCompletionDocuments
  import TugasWeb.ObligationDocumentThumb
  import TugasWeb.ObligationStepFiles

  alias TugasWeb.ModalEscape
  alias TugasWeb.ObligationLive.DocumentHelpers

  import TugasWeb.ObligationLive.DocumentHelpers,
  ...
  alias Tugas.Obligations.{Obligation, Recurrence, Urgency}
  ...
  def render(assigns) do
    ...
    <Layouts.mobile_app flash={@flash} current_scope={@current_scope} active={:duties}>
      ...
      >
        <section id="obligation-summary" class="tugas-workbench tugas-obligation-summary">
          <div
            id="obligation-meta"
          ...
          <div
            ...
            class={TugasWeb.ObligationDocumentThumb.thumb_grid_classes(:mobile)}
          >
          ...
          >
            <div id="obligation-progress-actions" class="tugas-inline-actions gap-2">
              <button
            ...
            <div id="obligation-done-actions" class="tugas-inline-actions">
              <button
            ...
            <div id="obligation-series-actions" class="tugas-inline-actions gap-2">
              <button
