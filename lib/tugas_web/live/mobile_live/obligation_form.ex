defmodule TugasWeb.MobileLive.ObligationForm do
  @moduledoc """
  ...
  `TugasWeb.ObligationLive.CreateForm`.
  """
  use TugasWeb, :live_view

  alias TugasWeb.ObligationLive.CreateForm
  ...
  def mount(params, _session, socket) do
    if Tugas.Authorization.can?(socket.assigns.current_scope, :create_obligation) do
