defmodule TugasWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :tugas
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :tugas
  end
  ...
  plug Plug.Parsers,
    ...
    length: Tugas.Uploads.Limits.multipart_max_length(),
    json_decoder: Phoenix.json_library()

  plug Plug.MethodOverride
  plug Plug.Head
  plug Plug.Session, @session_options
  plug TugasWeb.Router
end
